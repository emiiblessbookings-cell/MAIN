...
const NotificationBanner: React.FC<NotificationBannerProps> = ({
    message = "📚welcome to emiisdtrade, Join our DAILY Trading Telegram! 🚀 for classes stragies and signals - Learn advanced trading strategies and watch real-time trades. Don't miss out on transforming your trading journey! Click to join our exclusive Telegram community.",
    isVisible = true,
    canClose = true,
    autoHide = false,
    autoHideDelay = 5000,
    telegramUrl = "https://t.me/emiisdtrader"
}) => {
