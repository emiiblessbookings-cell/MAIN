...
const InlineNotificationBanner: React.FC = () => {
  ...
  const handleClose = (e: React.MouseEvent) => {
    ...
    if (autoHideTimerRef.current) {
      clearTimeout(autoHideHideTimerRef.current);
    }
    try {
      localStorage.setItem("notification_banner_hidden", "1");
    } catch {
...
const InfoIcon: React.FC = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "YouTube",
      url: "https://www.youtube.com/@EmiisDtrader",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <Button
            onClick={() => {
              window.location.href =
                "https://hub.deriv.com/tradershub/signup?referrer=emiisdtrader.pages.dev&t=4827EA09-5685-4B2D-96E7-13A7D810E3B6&utm_campaign=dynamicworks&utm_medium=affiliate&utm_source=CU63317/";
            }}
          >
