            ...
            <div className='main'>
                ...
                >
                    <div>
                                ...
                                label={
                                    <>
                                        <LabelPairedPuzzlePieceTwoCaptionBoldIcon
                                            ...
                                            fill='var(--text-general)'
                                        />
                                        <Localize i18n_default_text='Smart Money' />
                                    </>
                                }
                                id='id-smart-trader'
                            >
                                <Suspense
                                    fallback={<ChunkLoader message={localize('Please wait, loading Smart Money...')} />}
                                >
                                    <SmartTrader />
                                </Suspense>
                            </div>
                                ...
                                label={
                                    <>
                                        <LabelPairedPuzzlePieceTwoCaptionBoldIcon
                                            ...
                                            fill='var(--text-general)'
                                        />
                                        <Localize i18n_default_text='pRO dTrader' />
                                    </>
                                }
                                id='id-pro-tool'
                            >
                                <Suspense
                                    fallback={<ChunkLoader message={localize('Please wait, loading pRO Trader...')} />}
                                >
                                    <Dtraders />
                                </Suspense>
                            </div>
                                ...
                                label={
                                    <>
                                        <LabelPairedSignalCaptionRegularIcon
                                            ...
                                            fill='var(--text-general)'
                                        />
                                        <Localize i18n_default_text='Advanced AI' />
                                    </>
                                }
                                id='id-copy-trading'
                            >
                                <Suspense
                                    fallback={
                                        <ChunkLoader message={localize('Please wait, loading Advanced AI ...')} />
                                    }
                                >
                                    <Advancedtools />
                                </Suspense>
                        ...
                        <div label={<><AnalysisToolIcon /><Localize i18n_default_text='All analysis' /></>} id='id-analysis-tool'
                             onClick={() => handleLinkChange('analysis')}
                            style={{ cursor: 'pointer' }}
                        >
                            <Suspense fallback={<ChunkLoader message={localize('Please wait, loading all analysis...')} />}>
                                <Tool />
                            </Suspense>
                           </div>
                        <div label={<><AiPageIcon /><Localize i18n_default_text='Signals  ' /></>} id='id-ai'
                             onClick={() => handleLinkChange('AiPage')}
                            style={{ cursor: 'pointer' }}
                        >
                            <Suspense fallback={<ChunkLoader message={localize('Please wait, Signals...')} />}>
                                <DisplayToggle />
                            </Suspense>
                           </div>
                              <div
